...
const Home = () => {
  ...
  return (
    <section className="max-w-7xl mx-auto">
      <div>
        <h1 className="font-extrabold text-[#222328] text-[32px]">AI Image Showcase</h1>
      ...
      <div className="mt-16">
        <FormField labelName="Search images" type="text" name="text" placeholder="Search..." value={searchText} handleChange={handleSearchChange} />
      </div>
        ...
        {loading ? (
          ...
          <>
            ...
            <div className="grid lg:grid-cols-4 sm:grid-cols-3 xs:grid-cols-2 grid-cols-1 gap-3">
              {searchText ? <RenderCards data={searchedResults} title="No Image Found" /> : <RenderCards data={allPosts} title="No Images Yet" />}
            </div>
          </>
        )}
      </div>
